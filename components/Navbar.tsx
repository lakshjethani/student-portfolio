    ...
    >
      ...
      >
        ...
        <button
          ...
          className="relative rounded-lg p-2.5 text-foreground-muted transition-colors hover:bg-surface hover:text-foreground focus:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed"
        >
          {mounted ? (
            isDark ? (
